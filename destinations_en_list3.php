    ...
    <body id="inner">
		<div id="shell">
            ...
            <div id="content">
                ...
                <div id="right">
                	<div id="crumb">
                    	<h1>BULGARIA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />SLOVAKIA</h1>
                        <h2 class="fl">SOFIA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />BANSKA BYSTRICA</h2>
                        <h3 class="fr"></h3>
                    </div>
                	...
                	<div id="crumb2">
                   	  <h1>SLOVAKIA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />BULGARIA</h1>
                        <h2>BANSKA BYSTRICA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />SOFIA</h2>
                    </div>
                    <table class="destinations" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
