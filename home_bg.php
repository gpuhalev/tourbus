       ...
       <p style="padding:10px 20px 0;"><strong> За повече информация, моля свържете се на телефоните в раздел "Контакти". </strong></p>
                ...
                <div id="right">
                    ...
                    <div id="page-text">
                    	...
                    	<p>
                   	    Фирмата е  една от първите  в страната, занимаваща  се с транспортна дейност и притежава лиценз на Европейската общност за  извършване на международен автобусен превоз на пътници.</p>
                    	<p>
                   	    В хода на  своята дейност  тя е работила съвместно с  международни партньори от страните, до които осъществява пътническите превози,  с някои от които продължава успешната си съвместна дейност.</p>
                    	<p>
                   	    Разполага  със собствена материална база за обслужване и поддръжка на техническия си парк  и автобуси, категоризирани и лицензирани  за международен автобусен превоз на пътници.  Автобусите се обслужват от квалифицирани екипажи (шофьори с богат опит).</p>
                    	<p>
                   	    Фирмата  има лицензирани линии до Полша,  Словакия и Унгария и разполага с административни офиси за координиране на  транспортния процес в СОФИЯ и ВАРШАВА.</p>
                    	<p>
                   	    Фирмата  работи с широка мрежа от агенти и комисионерски бюра в столицата и в множество  градове от вътрешността на страната ни, а така също има представителства и в  страните, до които пътува.</p>
                  </div>
                </div>
                <div class="cl no-text"><!-- --></div>
            </div>
