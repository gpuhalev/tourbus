		...
		<div id="shell">
            ...
            <div id="content">
                ...
                <div id="right">
                   ...
                   </p> <p>   W chwili obecnej mamy licencję na regularne linie autokarowe do  Polski, Słowacji i Węgier. Nasza firma ma swoje biura i punkty sprzedaży  w Sofii и Warszawie.</p>
                    <p>Firma  dysponuję ogromną siecią dystrybucyjną w kraju i zagranicą, korzystając zarówno  z własnych punktów sprzedaży jak również z usług pośredników.</p></div>
                </div>
                <div class="cl no-text"><!-- --></div>
            </div>
            <div id="footer">
