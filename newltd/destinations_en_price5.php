    ...
    <body id="inner">
		<div id="shell">
			<div id="header">
                ...
                <div id="head-right">
                	<div id="langs">
                        <a href="destinations_bg_price5.php" class="no-text" title="BG">BG</a>
                        <a href="destinations_pl_price5.php" class="no-text" title="PL">PL</a>
                        <a href="destinations_cz_price5.php" class="no-text" title="CZ">CZ</a>
                        <a href="destinations_en_price5.php" class="no-text" title="EN">EN</a>
                    </div>
