            	...
            	<div id="left">
                	<div id="readmore" class="box">
                        ...
                        <ul>
                        	...
                        	<li><a href="http://bg.wikipedia.org/wiki/%D0%91%D1%8A%D1%80%D0%BD%D0%BE">БЪРНО в Wikipedia</a><a href="http://bg.wikipedia.org/wiki/%D0%9F%D1%80%D0%B0%D0%B3%D0%B0"></a><a href="http://bg.wikipedia.org/wiki/%D0%9F%D1%80%D0%B0%D0%B3%D0%B0"></a></li>
                ...
                <div id="right">
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="price bg-aqua">190,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">171,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">152,00 лв</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td rowspan="4" class="people bg border-right">НОРМАЛЕН<br />14->26г. и пенсионери<br />7->14г.<br />ДЕТСКИ</td>
                                <td class="price bg-aqua">295,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">265,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">236,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">147,00 лв</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                            	<td rowspan="8" class="title bg orange border-right"><p>ЧЕНСТОХОВА</p>
                           	    <p>КАТОВИЦЕ</p></td>
                                <td rowspan="4" class="asar bg border-right">В една посока</td>
                                <td rowspan="4" class="people bg border-right">НОРМАЛЕН<br />14->26г. и пенсионери<br />7->14г.<br />ДЕТСКИ</td>
                                <td class="price bg-aqua">180,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">162,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">144,00 лв</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                            	<td rowspan="4" class="asar bg border-right">В две посоки</td>
                                <td rowspan="4" class="people bg border-right">НОРМАЛЕН<br />14->26г. и пенсионери<br />7->14г.<br />ДЕТСКИ</td>
                                <td class="price bg-aqua">275,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">247,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">220,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">137,00 лв</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                            	<td rowspan="8" class="title bg orange border-right"><p>КРАКОВ</p></td>
                                <td rowspan="4" class="asar bg border-right">В една посока</td>
                                <td rowspan="4" class="people bg border-right">НОРМАЛЕН<br />14->26г. и пенсионери<br />7->14г.<br />ДЕТСКИ</td>
                                <td class="price bg-aqua">170,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">153,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">136,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">85,00 лв</td>
                            </tr>
                            <tr>
                            	<td rowspan="4" class="asar bg border-right">В две посоки</td>
                                <td rowspan="4" class="people bg border-right">НОРМАЛЕН<br />14->26г. и пенсионери<br />7->14г.<br />ДЕТСКИ</td>
                                <td class="price bg-aqua">270,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">243,00 лв</td>
                            </tr>
                            <tr>
                            	<td class="price bg">216,00 лв</td>
                            </tr>
                            <tr>
