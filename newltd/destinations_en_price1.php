    ...
    <body id="inner">
		<div id="shell">
			<div id="header">
                ...
                <div id="head-right">
                	<div id="langs">
                        <a href="destinations_bg_price1.php" class="no-text" title="BG">BG</a>
                        <a href="destinations_pl_price1.php" class="no-text" title="PL">PL</a>
                        <a href="destinations_cz_price1.php" class="no-text" title="CZ">CZ</a>
                        <a href="destinations_en_price1.php" class="no-text" title="EN">EN</a>
                    </div>
                ...
                <div id="right">
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                            	 <tr>
                            	<td rowspan="8" class="title bg orange border-right">KATOWICE<br />
                            	CZESTOCHOWA</td>
                                <td rowspan="4" class="asar bg border-right">AS</td>
                                <td rowspan="4" class="people bg border-right">STANDARD<br />14->26y and over 60y<br />7->14y<br />Children</td>
