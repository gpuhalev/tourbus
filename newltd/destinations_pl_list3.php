    ...
    <body id="inner">
		<div id="shell">
            ...
            <div id="content">
                ...
                <div id="right">
                	<div id="crumb">
                    	<h1>BUŁGARIA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />SŁOWACJA</h1>
                        <h2 class="fl">SOFIA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />BAŃSKA BYSTRICA</h2>
                        <h3 class="fr"></h3>
                    </div>
                    <table class="destinations" border="0" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                               <th width="100" class="orange">13:00 &ndash; 5</th>
                                ...
                                <th width="410" class="white">SOFIA&nbsp;&nbsp;&nbsp;Dworzec Autobusowy "Serdika"</th>
                        ...
                        <tbody>
                             <tr>
                                <td>&nbsp;</td>
                                <td class="aqua bold">Tranzyt: Serbia</td>
                                <td>&nbsp;</td>
                            </tr>
                             <tr>
                	...
                	<div id="crumb2">
                    	<h1>SŁOWACJA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />BUŁGARIA</h1>
                        <h2>BAŃSKA BYSTRICA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />SOFIA</h2>
                    </div>
                    <table class="destinations" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                           <tr>
