    ...
    <body id="inner">
		<div id="shell">
			<div id="header">
                ...
                <div id="head-right">
                	<div id="langs">
                        <a href="destinations_bg_list4.php" class="no-text" title="BG">BG</a>
                        <a href="destinations_pl_list4.php" class="no-text" title="PL">PL</a>
                        <a href="destinations_cz_list4.php" class="no-text" title="CZ">CZ</a>
                        <a href="destinations_en_list4.php" class="no-text" title="EN">EN</a>
                    </div>
       ...
       <p style="padding:10px 20px 0;"><strong> За повече информация, моля свържете се на телефоните в раздел &quot;Контакти&quot;. </strong></p>
                ...
                <div id="right">
                    ...
                    <table class="destinations" border="0" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                                <th width="100" class="lblue bold-big">13:00 &ndash; 5</th>
