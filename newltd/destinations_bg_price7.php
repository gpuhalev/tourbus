    ...
    <body id="inner">
		<div id="shell">
			<div id="header">
                ...
                <div id="head-right">
                	<div id="langs">
                        <a href="destinations_bg_price7.php" class="no-text" title="BG">BG</a>
                        <a href="destinations_pl_price7.php" class="no-text" title="PL">PL</a>
                        <a href="destinations_cz_price7.php" class="no-text" title="CZ">CZ</a>
                        <a href="destinations_en_price7.php" class="no-text" title="EN">EN</a>
                    </div>
                ...
                <div id="right">
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                            	<td rowspan="8" class="title bg orange border-right">БУДАПЕЩА</td>
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                            	<td colspan="3" width="460" class="title bg lblue border-right">ТУРИНГ БУС</td>
                                <td width="150" class="subtitle bg orange">ЧЕНСТОХОВА, КАТОВИЦЕ</td>
                            </tr>
                            <tr>
                            	<td width="210" class="bold bg">Присига в:</td>
                                <td width="100" class="small bg">посока</td>
                      ...
                      <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                            	<td colspan="3" width="460" class="title bg lblue border-right">ТУРИНГ БУС</td>
                                <td width="150" class="subtitle bg orange">КРАКОВ</td>
                            </tr>
                            <tr>
                            	<td width="210" class="bold bg">Присига в:</td>
                                <td width="100" class="small bg">посока</td>
