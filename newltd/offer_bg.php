    ...
    <body id="inner">
		<div id="shell">
			<div id="header">
                ...
                <div id="head-right">
                	<div id="langs">
                        <a href="offer_bg.php" class="no-text" title="BG">BG</a>
                        <a href="offer_pl.php" class="no-text" title="PL">PL</a>
                        <a href="offer_cz.php" class="no-text" title="CZ">CZ</a>
                        <a href="offer_en.php" class="no-text" title="EN">EN</a>
                    </div>
                    ...
                    <div id="menu">
                    	<ul>
                        	...
                        	<li><a href="offer_bg.php" class="active">Оферта</a></li>
       ...
       <p style="padding:10px 20px 0;"><strong> За повече информация, моля свържете се на телефоните в раздел &quot;Контакти&quot;. </strong></p>
                ...
                <div id="right">
                    ...
                    <div id="page-text">
						<p>Фирмата предлата под наем автобуси, отговарящи на изискванията за превоз на пътници в страната и чужбина. Автобусите ,с които разполагаме са от марките : <b>Мерцедес</b>, <b>Бова</b> и <b>ЕОС</b> с конфигурация на местата: 44, 49 и 57 пътнически места.</p>
                    </div>
                </div>
                <div class="cl no-text"><!-- --></div>
            </div>
