    ...
    <body id="inner">
		<div id="shell">
			<div id="header">
                ...
                <div id="head-right">
                	<div id="langs">
                        <a href="destinations_bg_price6.php" class="no-text" title="BG">BG</a>
                        <a href="destinations_pl_price6.php" class="no-text" title="PL">PL</a>
                        <a href="destinations_cz_price6.php" class="no-text" title="CZ">CZ</a>
                        <a href="destinations_en_price6.php" class="no-text" title="EN">EN</a>
                    </div>
            	...
            	<div id="left">
                	<div id="readmore" class="box">
                        ...
                        <ul>
                        	...
                        	<li><a href="http://en.wikipedia.org/wiki/Praga">Prague in Wikipedia</a></li>
