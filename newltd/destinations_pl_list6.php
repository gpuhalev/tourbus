    ...
    <body id="inner">
		<div id="shell">
            ...
            <div id="content">
                ...
                <div id="right">
                	<div id="crumb">
                    	<h1>POLSKA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" /><strong>SŁOWACJA</strong></h1>
                        <h2 class="fl">WARSZAWA<strong><img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />BAŃSKA BYSTRICA</strong></h2>
                	...
                	<div id="crumb2">
                   	  <h1>SŁOWACJA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />POLSKA</h1>
                        <h2>BAŃSKA BYSTRICA<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />WARSZAWA</h2>
                    </div>
                    <table class="destinations" border="0" cellpadding="0" cellspacing="0">
                        <thead>
                             <tr>
