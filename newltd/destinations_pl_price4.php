            	...
            	<div id="left">
                	<div id="readmore" class="box">
                        ...
                        <ul>
                        	...
                        	<li><a href="http://pl.wikipedia.org/wiki/Brno">BRNO w Wikipedii</a><a href="http://pl.wikipedia.org/wiki/Praga"></a></li>
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="150" class="bg price">BRUTTO</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                            	<td rowspan="5" class="asar bg border-right">AR</td>
                                <td rowspan="5" class="people bg border-right">NORMALNY<br />14->26l. i pow. 60l.<br />7->14l.<br />DZIECIĘCA</td>
