    ...
    <body id="inner">
		<div id="shell">
			<div id="header">
                ...
                <div id="head-right">
                	<div id="langs">
                        <a href="destinations_bg_price2.php" class="no-text" title="BG">BG</a>
                        <a href="destinations_pl_price2.php" class="no-text" title="PL">PL</a>
                        <a href="destinations_cz_price2.php" class="no-text" title="CZ">CZ</a>
                        <a href="destinations_en_price2.php" class="no-text" title="EN">EN</a>
                    </div>
            	...
            	<div id="left">
                	<div id="readmore" class="box">
                        ...
                        <ul>
                        	...
                        	<li><a href="https://en.wikipedia.org/wiki/Brno">BRNO in Wikipedia</a><a href="http://en.wikipedia.org/wiki/Praga"></a></li>
                ...
                <div id="right">
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                            	<td rowspan="8" class="title bg orange border-right"><p>WARSAW</p>
                           	    <p>LODZ</p></td>
                            ...
                            <tr>
                                ...
                                <td rowspan="4" class="people bg border-right">STANDARD<br />14->26y and over 60y.<br />7->14y<br />Children</td>
                                <td class="price bg-aqua">150,00 €</td>
                            </tr>
                            <tr>
                            	<td class="price bg">135,00 €</td>
                            </tr>
                            <tr>
                            	<td class="price bg">120,00 €</td>
                            </tr>
                            <tr>
                            	<td class="price bg">75,00 €</td>
                            </tr>
                        </tbody>
                    </table>
                     ...
                     <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                            	<td rowspan="8" class="title bg orange border-right"><p>KATOWICE</p>
                           	    <p>CZESTOCHOWA</p></td>
                                <td rowspan="4" class="asar bg border-right">AS</td>
                                <td rowspan="4" class="people bg border-right">STANDARD<br />14->26y and over 60y.<br />7->14y<br />Children</td>
                                <td class="price bg-aqua">90,00 €</td>
                            </tr>
                            <tr>
                            	<td class="price bg">81,00 €</td>
                            </tr>
                            <tr>
                            	<td class="price bg">72,00 €</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                            	<td rowspan="4" class="asar bg border-right">AR</td>
                                <td rowspan="4" class="people bg border-right">STANDARD<br />14->26y and over 60y.<br />7->14y<br />Children</td>
                                <td class="price bg-aqua">140,00 €</td>
                            </tr>
                            <tr>
                            	<td class="price bg">126,00 €</td>
                            </tr>
                            <tr>
                            	<td class="price bg">112,00 €</td>
                            </tr>
                            <tr>
                            	<td class="price bg">70,00 €</td>
                            </tr>
                        </tbody>
                    </table>
