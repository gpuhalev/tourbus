                ...
                <div id="right">
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="price bg-aqua">210,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">189,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">168,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">105,00 zł</td>
                            </tr>
                            <tr>
                            	<td rowspan="4" class="asar bg border-right">AR</td>
                                <td rowspan="4" class="people bg border-right">NORMALNY<br />14->26l. i pow. 60l.<br />7->14l.<br />DZIECIĘCA</td>
                                <td class="price bg-aqua">388,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">349,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">310,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">194,00 zł</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td rowspan="4" class="asar bg border-right">AS</td>
                                <td rowspan="4" class="people bg border-right">NORMALNY<br />14->26l. i pow. 60l.<br />7->14l.<br />DZIECIĘCA</td>
                                <td class="price bg-aqua">190,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">171,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">152,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">95,00 zł</td>
                            </tr>
                            <tr>
                            	<td rowspan="4" class="asar bg border-right">AR</td>
                                <td rowspan="4" class="people bg border-right">NORMALNY<br />14->26l. i pow. 60l.<br />7->14l.<br />DZIECIĘCA</td>
                                <td class="price bg-aqua">312,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">280,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">250,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">156,00 zł</td>
                            </tr>
                        </tbody>
                    </table>
					<table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td rowspan="4" class="asar bg border-right">AS</td>
                                <td rowspan="4" class="people bg border-right">NORMALNY<br />14->26l. i pow. 60l.<br />7->14l.<br />DZIECIĘCA</td>
                                <td class="price bg-aqua">170,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">153,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">136,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">85,00 zł</td>
                            </tr>
                            <tr>
                            	<td rowspan="4" class="asar bg border-right">AR</td>
                                <td rowspan="4" class="people bg border-right">NORMALNY<br />14->26l. i pow. 60l.<br />7->14l.<br />DZIECIĘCA</td>
                                <td class="price bg-aqua">276,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">248,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">220,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">138,00 zł</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                            	<td colspan="3" width="460" class="title bg lblue border-right">TOURING BUS</td>
                                <td width="150" class="subtitle bg orange"> BUDAPESZT</td>
                            </tr>
                            <tr>
                            	<td width="210" class="bold bg">Przyjazd do:</td>
                                <td width="100" class="small bg">strona</td>
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td rowspan="4" class="asar bg border-right">AS</td>
                                <td rowspan="4" class="people bg border-right">NORMALNY<br />14->26l. i pow. 60l.<br />7->14l.<br />DZIECIĘCA</td>
                                <td class="price bg-aqua">240,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">216,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">192,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">120,00 zł</td>
                            </tr>
                            <tr>
                            	<td rowspan="4" class="asar bg border-right">AR</td>
                                <td rowspan="4" class="people bg border-right">NORMALNY<br />14->26l. i pow. 60l.<br />7->14l.<br />DZIECIĘCA</td>
                    ...
                    <table class="destinations dest-prices" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                            	<td colspan="3" width="460" class="title bg lblue border-right">TOURING BUS</td>
                                <td width="150" class="subtitle bg orange"> CZĘSTOCHOWA, KATOWICE, KRAKÓW</td>
                            </tr>
                            <tr>
                            	<td width="210" class="bold bg">Przyjazd do:</td>
                                <td width="100" class="small bg">strona</td>
                            ...
                            <tr>
                                ...
                                <td rowspan="4" class="asar bg border-right">AS</td>
                                <td rowspan="4" class="people bg border-right">NORMALNY<br />14->26l. i pow. 60l.<br />7->14l.<br />DZIECIĘCA</td>
                                <td class="price bg-aqua">200,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">180,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">160,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">100,00 zł</td>
                            </tr>
                            <tr>
                            	<td rowspan="4" class="asar bg border-right">AR</td>
                                <td rowspan="4" class="people bg border-right">NORMALNY<br />14->26l. i pow. 60l.<br />7->14l.<br />DZIECIĘCA</td>
                                <td class="price bg-aqua">300,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">270,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">240,00 zł</td>
                            </tr>
                            <tr>
                            	<td class="price bg">150,00 zł</td>
                            </tr>
                        </tbody>
                    </table>
