		...
		<div id="shell">
			<div id="header">
                ...
                <div id="head-right">
                    ...
                    <div id="menu">
                    	<ul>
                        	<li><a href="home_en.php" class="active">Home</a></li>
...
The company has licensed lines to Poland, the Czech Republic, Slovakia and Hungary and has administration offices of the transport process in Sofia, Warsaw and Prague.</p><p>
The company works with an extensive network of agents and brokerage offices in the capital and in many inner cities of our country, and also has offices in the countries to which travel.</p></div>
                </div>
                <div class="cl no-text"><!-- --></div>
            </div>
            <div id="footer">
