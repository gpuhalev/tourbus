    ...
    <body id="inner">
		<div id="shell">
			<div id="header">
                ...
                <div id="head-right">
                	<div id="langs">
                        <a href="destinations_bg_list7.php" class="no-text" title="BG">BG</a>
                        <a href="destinations_pl_list7.php" class="no-text" title="PL">PL</a>
                        <a href="destinations_cz_list7.php" class="no-text" title="CZ">CZ</a>
                        <a href="destinations_en_list7.php" class="no-text" title="EN">EN</a>
                    </div>
       ...
       <p style="padding:10px 20px 0;"><strong> За повече информация, моля свържете се на телефоните в раздел &quot;Контакти&quot;. </strong></p>
                ...
                <div id="right">
                	<div id="crumb">
                    	<h1>ПОЛША<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />УНГАРИЯ</h1>
                        <h2 class="fl">ВАРШАВА<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />БУДАПЕЩА</h2>
                        <h3 class="fr"></h3>
                    </div>
                    <table class="destinations" border="0" cellpadding="0" cellspacing="0">
                        <thead>
                             <tr>
                                <th width="100" class="orange bold-big">09:30 &ndash; 7</th>
                                <th class="white">ВАРШАВА&nbsp;&nbsp;&nbsp;PKS Автогара "Заходни"</th>
                                <th>&nbsp;</th>
                            </tr>
                            <tr>
                           ...
                           <tr>
                            ...
                            <tr>
                                <td class="orange bold-big">21:00 &ndash; 7</td>
                                <td class="white">БАНСКА БИСТРИЦА&nbsp;&nbsp;&nbsp;Автогара, с-р №6</td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td class="orange bold-big">23:55 &ndash; 7</td>
                	...
                	<div id="crumb2">
                    	<h1>УНГАРИЯ<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />ПОЛША</h1>
                        <h2>БУДАПЕЩА<img src="css/images/crumb-arrow.png" width="14" height="14" alt="arrow" />ВАРШАВА</h2>
                    </div>
                    <table class="destinations" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                         <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td class="white"><span class="gray">КАТОВИЦЕ&nbsp;&nbsp;&nbsp;PKS Автогара, ул. &quot;Пьотра Скарги&quot;</span></td>
                                <td>&nbsp;</td>
                            </tr>
                             <tr>
                                <td class="lblue bold-big">12:30 &ndash; 6</td>
                                <td class="white"><span class="gray">ЧЕНСТОХОВА&nbsp;&nbsp;&nbsp;Автогара, алея &quot;Волношчи&quot; №45, перон №13</span></td>
                                <td>&nbsp;</td>
                            </tr>
							<tr>
