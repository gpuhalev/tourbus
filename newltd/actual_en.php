    ...
    <body id="inner">
		<div id="shell">
			<div id="header">
                ...
                <div id="head-right">
                	<div id="langs">
                        <a href="actual_bg.php" class="no-text" title="BG">BG</a>
                        <a href="actual_pl.php" class="no-text" title="PL">PL</a>
                        <a href="actual_cz.php" class="no-text" title="CZ">CZ</a>
                        <a href="actual_en.php" class="no-text" title="EN">EN</a>
                    </div>
                    ...
                    <div id="menu">
                    	<ul>
                        	...
                        	<li><a href="actual_en.php" class="active">Connections</a></li>
            ...
            <div id="content">
            	<div id="left">
                    ...
                    <div id="left-contacts">
                        ...
                        <p>Е-mail: <a href="mailto:touringbus@abv.bg">touringbus@abv.bg</a></p>
                    </div>
                </div>
                <div id="right">
                	<div id="crumb">
