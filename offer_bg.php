    ...
    <body id="inner">
       ...
       <p style="padding:10px 20px 0;"><strong> За повече информация, моля свържете се на телефоните в раздел &quot;Контакти&quot;. </strong></p>
                ...
                <div id="right">
                    ...
                    <div id="page-text">
						<p>Фирмата предлата под наем автобуси, отговарящи на изискванията за превоз на пътници в страната и чужбина. Автобусите, с които разполагаме са от марките <b>Ланхол</b> и <b>Сетра</b> със съответно 49 и 24 пътнически места.</p>
                    </div>
                </div>
                <div class="cl no-text"><!-- --></div>
            </div>
